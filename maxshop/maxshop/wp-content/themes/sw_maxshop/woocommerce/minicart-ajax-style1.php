...
<div class="top-form top-form-minicart  minicart-product-style2 pull-right">
	...
	<h2><?php esc_html_e('Shopping Cart','maxshop');?></h2>
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_attr_e('View your shopping cart', 'maxshop'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>'; esc_html_e('item(s)', 'maxshop');?> - <?php echo $woocommerce->cart->get_cart_subtotal(); ?></a>
