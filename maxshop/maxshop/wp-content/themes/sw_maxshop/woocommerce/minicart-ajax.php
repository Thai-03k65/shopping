...
<div class="top-form top-form-minicart minicart-product-style1 pull-right">
	<div class="top-minicart pull-right">
		...
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_attr_e('View your shopping cart', 'maxshop'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>'?></a>
