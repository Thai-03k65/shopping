				...
				<div class="container clearfix">
					<div class="copyright-text pull-left">
						<?php if( $ya_copyright_text == '' ) : ?>
							<?php esc_html_e( "Copyright &copy; ", 'maxshop' )?><?php echo date('Y '); ?><?php echo 'SW MaxShop Store. All Rights Reserved. Design by <a href="http://www.smartaddons.com/" target="_blank" title="Wordpress Themes, Joomla Templates">Smartaddons.com</a>'?>
						<?php else : ?>
